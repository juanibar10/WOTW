...
namespace MalbersAnimations.Controller
{
   ...
   // [CanEditMultipleObjects]
    public class ZoneEditor : Editor
    {
        ...
        SerializedProperty
            HeadOnly, stateAction, HeadName, zoneType, stateID, modeID, ID, ActionID, auto, AutomaticDisabled, stanceAction,
            AlignPos, AlignRot, AlignLookAt, AlingPoint, AlingPoint2, AlignTime, statModifier, stanceID;
